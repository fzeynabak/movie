...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  playVideoFile: (filepath, originPeerIp, subtitlesList) => ipcRenderer.invoke('play-video-file', filepath, originPeerIp, subtitlesList),
  ...
  pauseCopy: (id) => ipcRenderer.invoke('pause-copy', id),
  resumeCopy: (id) => ipcRenderer.invoke('resume-copy', id),
